class Person:
    def __init__(self, name, gender):  # attribute initializer. Object is already created before this method is called
        self.name = name
        self.gender = gender
        self.__secret = None
    ...
    def __setattr__(self, key, value):
        if key == "name":
            if type(value) is not str:
                raise ValueError(f"name is not str type but it is {type(value)}")
